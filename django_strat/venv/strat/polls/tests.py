...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        pub_date is more then 14 days old.
        """
        time = timezone.now() - datetime.timedelta(days=14, seconds=1)
...
class QuestionIndezViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Even if post past and future questions exist, only
        past question are displayed.
        """
        create_question(question_text='Past Question', days=-30)
        create_question(question_text='Future Question', days=30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_two_past_questions(self):
        """
        The question index can display multiple questions.
        """
